...
SpellProc* SpellProcMgr::NewSpellProc(Unit* target, uint32 spell_id, uint32 orig_spell_id, uint64 caster, uint32 procChance, uint32 procFlags, uint32 procCharges, uint32 const* groupRelation, uint32* procClassMask, Object* obj)
{
...
SpellProc* SpellProcMgr::NewSpellProc(Unit* target, SpellInfo const* spell, SpellInfo const* orig_spell, uint64 caster, uint32 procChance, uint32 procFlags, uint32 procCharges, uint32 const* groupRelation, uint32* procClassMask, Object* obj)
{
    if (spell == NULL)
        return NULL;
