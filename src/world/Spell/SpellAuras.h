...
struct Modifier
{
    ...
    AuraModTypes m_type;     // What does it modify? (str,int,hp)
...
class SERVER_DECL Aura : public EventableObject
{
    public:
        ...
        void Remove();
        void AddMod(AuraModTypes t, int32 a, uint32 miscValue, uint32 i);
        ...
        bool HasModType(AuraModTypes type)
        {
        ...
        void SendModifierLog(int32** m, int32 v, uint32 const* mask, uint8 type, bool pct = false);
