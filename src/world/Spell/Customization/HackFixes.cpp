...
void ApplyNormalFixes()
{
    ...
    for (auto it = sSpellCustomizations.GetSpellInfoStore()->begin(); it != sSpellCustomizations.GetSpellInfoStore()->end(); ++it)
    {
        ...
        {
            if (sp->EffectTriggerSpell[b] != 0 && sSpellCustomizations.getSpellInfoUnsafe(sp->EffectTriggerSpell[b]) == NULL)
            {
        ...
        {
        case 70908:
            sp->EffectImplicitTargetA[0] = EFF_TARGET_DYNAMIC_OBJECT_FRONT;
            break;
    ...
    if (sp != nullptr)
    {
        ...
        sp->EffectImplicitTargetA[0] = EFF_TARGET_22;
        sp->EffectImplicitTargetB[0] = EFF_TARGET_22;
        sp->EffectImplicitTargetA[1] = EFF_TARGET_22;
        sp->EffectImplicitTargetB[1] = EFF_TARGET_22;
        sp->EffectImplicitTargetA[2] = EFF_TARGET_22;
        sp->EffectImplicitTargetB[2] = EFF_TARGET_22;
    }
    ...
    if (sp != nullptr)
    {
        sp->EffectImplicitTargetA[2] = EFF_TARGET_22; // cebernic: for enemies not self
    }
    ...
    if (sp != nullptr)
    {
        sp->EffectImplicitTargetA[0] = EFF_TARGET_ALL_PARTY_2;
        sp->EffectImplicitTargetA[1] = EFF_TARGET_ALL_PARTY_2;
        sp->EffectImplicitTargetA[2] = 0;
        sp->EffectImplicitTargetB[0] = 0;
        sp->EffectImplicitTargetB[1] = 0;
        sp->EffectImplicitTargetB[2] = 0;
    ...
    if (sp != nullptr)
    {
        for (uint8 i = 0; i < 3; ++i)
        {
            if (sp->EffectImplicitTargetA[i] > 0)
                sp->EffectImplicitTargetA[i] = EFF_TARGET_ALL_FRIENDLY_AROUND_CASTER;
            if (sp->EffectImplicitTargetB[i] > 0)
                sp->EffectImplicitTargetB[i] = EFF_TARGET_ALL_FRIENDLY_AROUND_CASTER;
        }
    }
    ...
    // Runic Empowerment
    sp = sSpellCustomizations.getSpellInfoUnsafe(81229);
    if (sp != nullptr)
    {
        sp->procFlags = PROC_ON_CAST_SPELL;
        sp->EffectApplyAuraName[0] = SPELL_AURA_PROC_TRIGGER_SPELL;
