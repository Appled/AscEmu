...
void WorldSession::HandleLootOpcode(WorldPacket& recv_data)
{
    ...
    if (_player->isStealthed())    // Check if the player is stealthed
        _player->removeAurasWithModType(SPELL_AURA_MOD_STEALTH); // cebernic:RemoveStealth on looting. Blizzlike
    ...
    if (_player->isInvisible())    // Check if the player is invisible for what ever reason
        _player->removeAurasWithModType(SPELL_AURA_MOD_INVISIBILITY); // Remove all invisibility
...
void WorldSession::HandleGameObjectUse(WorldPacket& recv_data)
{
    ...
    _player->removeAurasWithModType(SPELL_AURA_MOD_STEALTH); // cebernic:RemoveStealth due to GO was using. Blizzlike
