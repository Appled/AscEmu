...
public:
    ...
    int32_t doSpellDamage(Unit* victim, uint32_t spellId, int32_t damage, bool allowProc = true, bool staticDamage = false, bool isPeriodic = false, bool isLeech = false, bool forceCrit = false, Aura* aur = nullptr, AuraEffectModifier* aurEff = nullptr);
