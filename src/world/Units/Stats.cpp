...
uint32 CalculateDamage(Unit* pAttacker, Unit* pVictim, uint32 weapon_damage_type, uint32 const* spellgroup, SpellInfo const* ability)   // spellid is used only for 2-3 spells, that have AP bonus
{
